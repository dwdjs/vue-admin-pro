<template>
  <div class="components-container">
    <aside>Markdown is based on
      <a rel="noopener noreferrer" href="https://github.com/nhnent/tui.editor" target="_blank">tui.editor</a> ，simply wrapped with Vue.
      <a
    ...
    <el-button @click="getHtml" style="margin-top: 80px;" type="primary" icon="el-icon-document">
      Get HTML
    </el-button>
    <div v-html="html" />
  </div>
