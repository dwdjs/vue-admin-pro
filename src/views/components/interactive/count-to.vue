<template>
  <div class="components-container">
    <aside>
      <a rel="noopener noreferrer" href="https://github.com/PanJiaChen/vue-countTo" target="_blank">countTo-component</a>
    </aside>
    <count-to
      ref="example"
      :start-val="_startVal"
    ...
    <div style="margin-left: 25%;margin-top: 40px;">
      ...
      <div @click="start" class="startBtn example-btn">
        Start
      </div>
      <div @click="pauseResume" class="pause-resume-btn example-btn">
        pause/resume
      </div>
      <br>
